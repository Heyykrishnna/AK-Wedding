...
import CartoonCutouts from './CartoonCutouts';
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-floral">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-8 left-8 text-wedding-gold/40 z-20">
        ...
        <div className="absolute top-8 right-8 text-wedding-gold/35 z-20">
        ...
        <div className="absolute bottom-32 left-16 text-wedding-gold/30 z-20">
        ...
        <div className="absolute bottom-32 right-16 text-wedding-gold/30 z-20">
          <svg width="60" height="80" viewBox="0 0 60 80" fill="currentColor" className="drop-shadow-md">
            {/* Stem */}
      ...
      <div className="container px-4 py-24 md:py-32 z-30 text-center">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-float z-30">
